...
class ProjectStage(StafflaneModel):
    """
    ProjectStage model
    """
    ...
    objects = StafflaneCompanyManager("project__company_id")
...
class TimeSheet(StafflaneModel):
    """
    TimeSheet model
    """
    ...
    objects = StafflaneCompanyManager("project_id__company_id")
