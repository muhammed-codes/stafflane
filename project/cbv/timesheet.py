...
class TimeSheetNavView(StafflaneNavView):
    """
    Nav bar
    """
...
class TimeSheetList(StafflaneListView):
    """
...
class TimeSheetFormView(StafflaneFormView):
    """
...
class TimeSheetCardView(StafflaneCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(StafflaneDetailedView):
    """
