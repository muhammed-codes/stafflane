...
class ProjectStageCreateForm(StafflaneFormView):
    """
    ...
    def get(self, request, *args, pk=None, **kwargs):
        ...
        if project_id:
            try:
                ...
                logger.error(e)
                return StafflaneRedirect(request, message=_("Something went wrong!"))
        else:
            return super().get(request, *args, pk=pk, **kwargs)
...
class StageDynamicCreateForm(ProjectStageCreateForm):
    ...
    template_name = StafflaneFormView.template_name
