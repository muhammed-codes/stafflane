...
This module is used to write stafflane form select widgets
"""
...
class StafflaneMultiSelectWidget(forms.Widget):
    """
    StafflaneMultiSelectWidget
    """
    ...
    template_name = "stafflane_widgets/stafflane_multiselect_widget.html"
