...
class LDAPSettings(models.Model):
    ...
    bind_dn = models.CharField(max_length=255, default="cn=admin,dc=stafflane,dc=com")
    bind_password = models.CharField(max_length=255)
    base_dn = models.CharField(max_length=255, default="ou=users,dc=stafflane,dc=com")
