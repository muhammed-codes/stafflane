...
class SkillZoneStatusList(StafflaneListView):
    """
...
class CandidateOnOnboardList(StafflaneListView):
    """
...
class CurrentHiringList(StafflaneListView):
    """
...
class OnGoingRecruitmentList(StafflaneListView):
    """
