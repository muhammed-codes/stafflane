...
class LinkedinSettingSectionView(views.StafflaneSectionView):
    """
...
class LinkedInSettingNavView(views.StafflaneNavView):
    """
...
class LinkedInAccountFormView(views.StafflaneFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.StafflaneListView):
    """
