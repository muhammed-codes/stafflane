...
from base.forms import ModelForm as StafflaneModelForm
...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = StafflaneMultiSelectField(
...
class KRForm(StafflaneModelForm):
    """
...
class FeedbackForm(StafflaneModelForm):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # # Stafflane multi-select filter for subordinates
        # self.fields["subordinate_id"] = StafflaneMultiSelectField(
        #     queryset=Employee.objects.all(),
        #     widget=StafflaneMultiSelectWidget(
        #         filter_route_name="employee-widget-filter",
        #         filter_class=EmployeeFilter,
...
class BonusPointSettingForm(StafflaneModelForm):
    """
...
class EmployeeBonusPointForm(StafflaneModelForm):
    """
...
class EmployeeFeedbackForm(StafflaneModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["others_id"] = StafflaneMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=StafflaneMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["others_id"], StafflaneMultiSelectField):
...
class BulkFeedbackForm(StafflaneModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_ids"] = StafflaneMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=StafflaneMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["employee_ids"], StafflaneMultiSelectField):
