...
class Offboarding(StafflaneModel):
    """
    Offboarding model
    """
...
class OffboardingStage(StafflaneModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(StafflaneModel):
    """
...
class OffboardingEmployee(StafflaneModel):
    """
...
class ResignationLetter(StafflaneModel):
    """
...
class OffboardingTask(StafflaneModel):
    """
...
class EmployeeTask(StafflaneModel):
    """
    EmployeeTask model
    """
...
class ExitReason(StafflaneModel):
    """
    ExitReason model
    """
...
class OffboardingNote(StafflaneModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(StafflaneModel):
    """
