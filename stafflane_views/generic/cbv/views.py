...
from stafflane.filters import FilterSet
...
from stafflane.signals import post_generic_import, pre_generic_import
from stafflane_views import models
from stafflane_views.cbv_methods import (  # update_initial_cache,
    assign_related,
    export_xlsx,
...
from stafflane_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
...
class StafflaneListView(ListView):
    """
    StafflaneListView
    """
    ...
    template_name: str = "generic/stafflane_list_table.html"
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        if request and self._saved_filters.get("field"):
            ...
            try:
                ...
                self.template_name = "generic/stafflane_list_table.html"
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[StafflaneListView] = context
        from stafflane.urls import path, urlpatterns
...
class StafflaneSectionView(TemplateView):
    """
    Stafflane Template View
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, StafflaneListView)
    ...
    template_name = "generic/stafflane_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class StafflaneDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = _("Detailed View")
    template_name = "generic/stafflane_detailed_view.html"
    header: dict = {
        "title": "Stafflane",
        "subtitle": "Stafflane Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, StafflaneDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class StafflaneTabView(TemplateView):
    """
    StafflaneTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/stafflane_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.query_params = {}
        # update_initial_cache(request, CACHE, StafflaneTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[StafflaneTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class StafflaneCardView(ListView):
    """
    StafflaneCardView
    """
    ...
    template_name = "generic/stafflane_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, StafflaneCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[StafflaneCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
@method_decorator(hx_request_required, name="dispatch")
class StafflaneFormView(FormView):
    """
    StafflaneFormView
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, StafflaneFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not isinstance(existing_form, forms.BaseForm):
            ...
            if self.request.method == "GET":
                ...
                for dynamic_tuple in self.dynamic_create_fields:
                    ...
                    form.fields[field].widget.option_template_name = (
                        "stafflane_widgets/select_option.html",
                    )
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[StafflaneFormView] = form
            self.form = form
        return self.form
...
@method_decorator(hx_request_required, name="dispatch")
class StafflaneNavView(TemplateView):
    """
    StafflaneNavView
    ...
    template_name = "generic/stafflane_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, StafflaneNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[StafflaneNavView] = context
        return context
...
@method_decorator(hx_request_required, name="dispatch")
class StafflaneProfileView(DetailView):
    """
    GenericStafflaneProfileView
    """

    template_name = "generic/stafflane_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.ordered_ids_key = f"ordered_ids_{self.model.__name__.lower()}"
        # update_initial_cache(request, CACHE, StafflaneProfileView)
