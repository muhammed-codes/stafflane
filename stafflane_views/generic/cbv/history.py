"""
stafflane_views/generic/cbv/history.py
"""
...
from stafflane_views.history_methods import get_diff


@method_decorator(login_required, name="dispatch")
@method_decorator(hx_request_required, name="dispatch")
class StafflaneHistoryView(DetailView):
    """
    GenericStafflaneProfileView
    """

    template_name = "generic/stafflane_history_view.html"
