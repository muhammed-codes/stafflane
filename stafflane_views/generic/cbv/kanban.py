"""
stafflane_views/generic/cbv/kanban.py
"""

from django.core.paginator import EmptyPage, PageNotAnInteger, Paginator
from django.db import models

from stafflane_views.cbv_methods import get_nested_field
from stafflane_views.generic.cbv.views import StafflaneCardView


class StafflaneKanbanView(StafflaneCardView):
    group_key: str = ""
    group_filter_class = None
    template_name: str = "generic/stafflane_kanban_view.html"
    kanban_attrs: str = ""
