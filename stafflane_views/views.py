...
from stafflane.signals import post_generic_delete, pre_generic_delete
...
from stafflane_views.forms import SavedFilterForm
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.StafflaneModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(StafflaneFormView):
    """
    SavedFilter
    """
...
@method_decorator(login_required, name="dispatch")
class DynamiListView(StafflaneListView):
    """
...
@method_decorator(login_required, name="dispatch")
class StafflaneDeleteConfirmationView(View):
    """
    ...
    def post(self, *args, **kwargs):
        ...
        return StafflaneFormView.HttpResponse(script=script)
...
def export_data(request, *args, **kwargs):
    ...
    model_path = request.GET.get("model")
    if not model_path:
        return StafflaneRedirect(request, message=_("No matching query found."))
