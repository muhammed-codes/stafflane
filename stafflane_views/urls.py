"""
stafflane_views/urls.py
"""

from django.urls import path

from stafflane_views import views
from stafflane_views.generic.cbv import history
from stafflane_views.generic.cbv.views import StafflaneListView, ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete/",
        views.StafflaneDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "stafflane-history-revert/<int:pk>/<int:history_id>/",
        history.StafflaneHistoryView.as_view(),
        name="history-revert",
    ),
    path(
