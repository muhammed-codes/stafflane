...
from stafflane_meet.methods import get_google_credentials
from stafflane_meet.models import *
...
@login_required
@permission_required("stafflane_meet.delete_googlecloudcredentials")
...
@login_required
@permission_required("stafflane_meet.add_googlemeeting")
@check_integration_enabled(app_name="stafflane_meet")
...
@login_required
@permission_required("stafflane_meet.delete_googlemeeting")
@check_integration_enabled(app_name="stafflane_meet")
