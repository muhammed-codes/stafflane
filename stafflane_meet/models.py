...
from stafflane.models import StafflaneModel, NoPermissionModel
...
class GoogleCredential(StafflaneModel, NoPermissionModel):
    """
...
class GoogleMeeting(StafflaneModel):
    """
