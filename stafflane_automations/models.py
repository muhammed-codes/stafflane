...
class MailAutomation(StafflaneModel):
    """
    MailAutoMation
    """
    ...
    def get_mail_to_display(self):
        ...
        return render_template(
            "stafflane_automations/mail_to.html", {"instance": self, "mappings": mappings}
        )

    def get_mail_cc_display(self):
        employees = self.also_sent_to.all()
        return render_template(
            "stafflane_automations/mail_cc.html", {"employees": employees}
        )
    ...
    def conditions(self):
        return render_template(
            "stafflane_automations/conditions.html", {"instance": self}
        )
    ...
    def detail_view_actions(self):
        ...
        return render_template(
            path="stafflane_automations/detail_actions.html",
