"""
stafflane_automation/signals.py
...
from stafflane.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    from stafflane_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=StafflaneMailTemplate)
    @receiver(post_save, sender=StafflaneMailTemplate)
...
def send_automated_mail(
    ...
    from stafflane_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from stafflane_automations.methods.methods import (
        get_model_class,
