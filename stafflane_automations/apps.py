"""
App configuration for the Stafflane Automations app.
...
class StafflaneAutomationConfig(AppConfig):
    """Configuration class for the Stafflane Automations Django app."""

    default_auto_field = "django.db.models.BigAutoField"
    name = "stafflane_automations"
    ...
    def ready(self) -> None:
        ...
        try:
            ...
            from stafflane_automations.methods.methods import get_related_models
            from stafflane_automations.models import MODEL_CHOICES
            ...
            try:
                from stafflane_automations.signals import start_automation
