"""
stafflane_automations/forms.py
"""
...
from stafflane_automations.models import MODEL_CHOICES, MailAutomation
...
class AutomationForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # --- Field: also_sent_to ---
        self.fields["also_sent_to"] = StafflaneMultiSelectField(
    ...
    def clean(self):
        ...
        if isinstance(self.fields["also_sent_to"], StafflaneMultiSelectField):
