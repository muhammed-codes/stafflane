# Stafflane API Documentation

This document provides information on how to use and maintain the API documentation for Stafflane HRMS.
...
```python
from stafflane_api.docs import document_api
...
- Module tags are defined in `stafflane_api/docs.py`
...
- Ensure the URL is included in the `patterns` list in `stafflane_api/urls.py`
