...
class StafflaneApiConfig(AppConfig):
    ...
    def ready(self):
        ...
        urlpatterns.append(
            path("api/", include("stafflane_api.urls")),
        )
        ...
        import stafflane_api.schema  # noqa
    ...
    def _configure_swagger_settings(self):
        ...
        swagger_config = {
            ...
            "DEFAULT_SCHEMA_CLASS": "stafflane_api.schema.ModuleTaggingAutoSchema",
        }
