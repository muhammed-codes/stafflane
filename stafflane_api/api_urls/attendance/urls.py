"""
stafflane_api/urls/attendance/urls.py
"""

from django.urls import path

from stafflane_api.api_views.attendance.permission_views import AttendancePermissionCheck
from stafflane_api.api_views.attendance.views import *
