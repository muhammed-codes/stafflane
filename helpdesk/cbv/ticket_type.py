...
class TicketsListView(StafflaneListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="helpdesk.view_tickettype"), name="dispatch")
class TicketsNavView(StafflaneNavView):
    """
...
class TicketTypeCreateForm(StafflaneFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TicketsCreateFormView(StafflaneFormView):
    """
