"""
Configuration for stafflane_dbtemplate.

Reads from Django settings with STAFFLANE_DBTEMPLATE_* prefix.
...
def get_setting(name, default=None):
    """Get a setting with STAFFLANE_DBTEMPLATE_ prefix."""
    full_name = f"STAFFLANE_DBTEMPLATE_{name}"
    return getattr(settings, full_name, default)


# Cache backend name from CACHES (e.g. "default" or "stafflane_dbtemplate")
