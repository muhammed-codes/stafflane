"""
Admin for stafflane_dbtemplate.
...
class TemplateVersionInline(admin.TabularInline):
    ...
    def version_actions(self, obj):
        ...
        restore_url = reverse(
            "admin:stafflane_dbtemplate_template_restore_version",
            args=[obj.template_id, obj.version],
        )
        diff_url = (
            reverse(
                "admin:stafflane_dbtemplate_template_diff",
...
class TemplateAdmin(admin.ModelAdmin):
    ...
    def lock_status_display(self, obj):
        ...
        if obj.is_locked():
            unlock_url = reverse(
                "admin:stafflane_dbtemplate_template_unlock",
                args=[obj.pk],
            )
            return format_html(
    ...
    def preview_panel(self, obj):
        ...
        preview_url = reverse(
            "admin:stafflane_dbtemplate_template_preview", args=[obj.pk]
        )
        return format_html(
            ...
            if version_count >= 2:
                ...
                if len(latest_versions) >= 2:
                    extra_context["diff_url"] = (
                        reverse("admin:stafflane_dbtemplate_template_diff", args=[obj.pk])
    ...
    def get_urls(self):
        ...
        custom = [
            path(
                ...
                name="stafflane_dbtemplate_template_restore_version",
            ),
            path(
                "<int:template_id>/diff/",
                self.admin_site.admin_view(self.diff_view),
                name="stafflane_dbtemplate_template_diff",
            ),
            path(
                "<int:pk>/preview/",
                self.admin_site.admin_view(self.preview_view),
                name="stafflane_dbtemplate_template_preview",
            ),
            path(
                "<int:pk>/unlock/",
                self.admin_site.admin_view(self.unlock_view),
                name="stafflane_dbtemplate_template_unlock",
            ),
        ]
        return custom + urls
    ...
    def restore_version_view(self, request, template_id, version):
        ...
        if request.method == "POST":
            ...
            return redirect(
                reverse("admin:stafflane_dbtemplate_template_change", args=[template_id])
            )

        # GET: confirmation page
        change_url = reverse(
            "admin:stafflane_dbtemplate_template_change", args=[template_id]
        )
        ...
        return TemplateResponse(
            request,
            "admin/stafflane_dbtemplate/template/restore_version.html",
            context,
        )
    ...
    def diff_view(self, request, template_id):
        ...
        return TemplateResponse(
            request,
            "admin/stafflane_dbtemplate/template/diff.html",
            context,
        )
    ...
    def preview_view(self, request, pk):
        ...
        change_url = reverse("admin:stafflane_dbtemplate_template_change", args=[pk])
        context = {
            **self.admin_site.each_context(request),
        ...
        return TemplateResponse(
            request,
            "admin/stafflane_dbtemplate/template/preview.html",
            context,
        )
    ...
    def unlock_view(self, request, pk):
        ...
        return redirect(reverse("admin:stafflane_dbtemplate_template_change", args=[pk]))
