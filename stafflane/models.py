...
This module defines the abstract base model `StafflaneModel` for the Stafflane HRMS project.
The `StafflaneModel` provides common fields and functionalities for other models within
...
from stafflane.inherit.model_inherit import (  # noqa: F401
    EXTENSION_REGISTRY,
    StafflaneModelBase,
)
...
class StafflaneModel(models.Model, metaclass=StafflaneModelBase):
    """
    An abstract base model that includes common fields and functionalities
    for models within the Stafflane application.
    """
    ...
    stafflane_history = AuditlogHistoryField()
    ...
    def save(self, *args, **kwargs):
        ...
        if request:
            ...
            if (
                ...
                and self._meta.get_field("created_by").related_model == StafflaneUser
            ):
        ...
        super(StafflaneModel, self).save(*args, **kwargs)
