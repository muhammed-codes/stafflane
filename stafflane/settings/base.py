"""
base.py — Main Django settings for Stafflane
"""
...
MIDDLEWARE = [
    ...
    # Stafflane-specific middlewares
    ...
    "stafflane.stafflane_middlewares.MethodNotAllowedMiddleware",
    "stafflane.stafflane_middlewares.SVGSecurityMiddleware",
    "stafflane.stafflane_middlewares.MissingParameterMiddleware",
    "auditlog.middleware.AuditlogMiddleware",
]

ROOT_URLCONF = "stafflane.urls"
...
AUTH_USER_MODEL = "stafflane_auth.StafflaneUser"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # Stafflane dynamic context processors
                "stafflane.config.get_MENUS",
...
WSGI_APPLICATION = "stafflane.wsgi.application"
...
LOCALE_PATHS = [join(BASE_DIR, "stafflane", "locale")]
...
# Audit logging is opt-in: the stafflane_audit app registers models explicitly
...
AUTH_LDAP_BIND_DN = env("AUTH_LDAP_BIND_DN", default="cn=admin,dc=stafflane,dc=com")
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": env("BIND_DN", default="cn=admin,dc=stafflane,dc=com"),
    "BIND_PASSWORD": env("BIND_PASSWORD", default=""),
    "BASE_DN": env("BASE_DN", default="ou=users,dc=stafflane,dc=com"),
}
