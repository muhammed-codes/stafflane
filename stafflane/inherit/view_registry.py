"""
stafflane/inherit/view_registry.py

Registry for the two _inherit modes supported by StafflaneViewInheritMixin.
...
def register_replacement(parent_cls, ext_cls) -> None:
    ...
    Called immediately when the extension class is defined (via StafflaneViewInheritMixin).
    """
