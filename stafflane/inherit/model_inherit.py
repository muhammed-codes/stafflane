"""
stafflane/inherit/model_inherit.py

StafflaneModelBase — metaclass for StafflaneModel that enables field and method
...
Usage in an extension app:
    ...
    class AssetExtension(StafflaneModel):
...
to the extension app via INJECTION_MAP + StafflaneAutodetector.
"""
...
class StafflaneModelBase(ModelBase):
    """
    Metaclass for StafflaneModel.
