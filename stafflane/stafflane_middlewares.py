"""
stafflane_middlewares.py

This module is used to register stafflane's middlewares without affecting the stafflane/settings.py
"""
...
from stafflane.config import logger
