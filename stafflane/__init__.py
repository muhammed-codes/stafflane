...
# Patch makemigrations and migrate to use StafflaneAutodetector.
#
...
try:
    ...
    from stafflane.inherit.autodetect import StafflaneAutodetector

    _MM.autodetector = StafflaneAutodetector
    _Migrate.autodetector = StafflaneAutodetector
except ImportError:
    pass
