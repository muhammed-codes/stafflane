...
from stafflane.stafflane_middlewares import _thread_locals, get_selected_company
from stafflane.signals import (
    post_bulk_update,
    post_model_clean,
    pre_bulk_update,
    pre_model_clean,
...
class StafflaneCompanyManager(models.Manager):
