"""
Stafflane management command to create a new user and associated employee.
"""
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            bot = StafflaneUser.objects.filter(username="Stafflane Bot").first()
            if bot is None:
                StafflaneUser.objects.create_user(
                    username="Stafflane Bot",
