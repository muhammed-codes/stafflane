...
class DefaultStafflaneMailBackend(EmailBackend):
    def __init__(
        self,
        host=None,
        port=None,
...
BACKEND_CLASS: EmailBackend = DefaultStafflaneMailBackend
default = "base.backends.ConfiguredEmailBackend"

setattr(BACKEND_CLASS, "send_messages", DefaultStafflaneMailBackend.send_messages)
