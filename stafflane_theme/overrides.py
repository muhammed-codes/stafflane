...
def get_stafflane_model_class(app_label, model):
    try:
...
Recruitment = get_stafflane_model_class(app_label="recruitment", model="recruitment")
AttendanceLateComeEarlyOut = get_stafflane_model_class(
...
Meetings = get_stafflane_model_class(app_label="pms", model="Meetings")
ResignationLetter = get_stafflane_model_class(
    app_label="offboarding", model="ResignationLetter"
)
AssetAssignment = get_stafflane_model_class(app_label="asset", model="AssetAssignment")
TimeSheet = get_stafflane_model_class(app_label="project", model="TimeSheet")
Deduction = get_stafflane_model_class(app_label="payroll", model="Deduction")
Task = get_stafflane_model_class(app_label="project", model="Task")
