...
@method_decorator(
    permission_required("stafflane_theme.view_stafflanecolortheme"),
    name="dispatch",
)
class ThemeView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["themes"] = StafflaneColorTheme.objects.all()
        ...
        default_theme = StafflaneColorTheme.get_default_theme()
...
@method_decorator(
    permission_required("stafflane_theme.change_stafflanecolortheme"),
    name="dispatch",
)
class ChangeThemeView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            theme = StafflaneColorTheme.objects.get(pk=theme_id)
        ...
        except StafflaneColorTheme.DoesNotExist:
    ...
    def _render_themes(self, request, active_theme=None, status=200):
        ...
        themes = StafflaneColorTheme.objects.all()
        active_company = getattr(request, "active_company", None)
...
@method_decorator(
    permission_required("stafflane_theme.add_stafflanecolortheme"),
    name="dispatch",
)
