...
class BiometricNavBar(StafflaneNavView):
    """
    nav bar of the page
    """
...
class BiometricCardView(StafflaneCardView):
    """
...
class BiometricFormView(StafflaneFormView):
    """
...
class BiometricSheduleForm(StafflaneFormView):
    """
