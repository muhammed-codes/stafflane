...
from stafflane_audit.forms import (
    AuditModelConfigForm,
    AuditModelFieldsForm,
    field_choices_for,
)
from stafflane_audit.models import AuditModelConfig
from stafflane_audit.registry import DEFAULT_TRACKED_MODELS


@login_required
@permission_required("stafflane_audit.view_auditmodelconfig")
def audit_model_settings(request):
    ...
    return render(
        request,
        "stafflane_audit/audit_model_settings.html",
        context,
    )


@login_required
@permission_required("stafflane_audit.change_auditmodelconfig")
...
def edit_audit_model_fields(request, pk):
    ...
    return render(
        request,
        "stafflane_audit/audit_model_fields_form.html",
