...
from stafflane_audit.filters import AudiTagFilter
...
@method_decorator(permission_required("stafflane_audit.view_audittag"), name="dispatch")
class AudiTagsList(StafflaneListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("stafflane_audit.view_audittag"), name="dispatch")
class AuditTagsNavView(StafflaneNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("stafflane_audit.add_audittag"), name="dispatch")
class AuditTagCreateForm(StafflaneFormView):
    """
