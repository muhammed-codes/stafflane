...
from stafflane_audit.methods import remove_duplicate_history
...
class StafflaneAuditInfo(models.Model):
    """
    StafflaneAuditInfo model to store additional info
    """
...
class StafflaneAuditLog(HistoricalRecords):
    """
    Model to store additional information for historical records.
    """

    # def __init__(self, *args, bases=None, **kwargs):
    #     super(StafflaneAuditLog, self).__init__(*args, **kwargs)
    #     self.is_stafflane_audit_log = True
...
def pre_create_stafflane_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_stafflane_audit_log(sender, instance, *_args, **kwargs):
    """
    ...
    try:
        ...
        if isinstance(history_instance, StafflaneAuditLog):
