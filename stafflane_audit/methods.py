...
from stafflane.decorators import apply_decorators
...
class Bot:
    ...
    def __str__(self) -> str:
        return "Stafflane Bot"

    def get_avatar(self):
        return "https://ui-avatars.com/api/?name=Stafflane+Bot&background=random"
...
def get_diff(instance):
    ...
    for pair in pairs:
        ...
        updated_by = (
            StafflaneUser.objects.get(id=pair[0].history_user.id).employee_get
...
def history_tracking(request, obj_id, **kwargs):
    ...
    def _history_tracking(request, obj_id, model):
        ...
        histories = instance.stafflane_history.all()
        ...
        return render(
            request,
            "stafflane_audit/history_tracking.html",
            context,
        )
