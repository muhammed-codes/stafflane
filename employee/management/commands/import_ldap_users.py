    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            for dn, entry in results:
                ...
                # Retrieve the associated StafflaneUser if it exists
                try:
                    user = StafflaneUser.objects.get(
                    ...
                    user.save()  # Save the changes to the StafflaneUser instance
                    action = "Updated"
                except StafflaneUser.DoesNotExist:
